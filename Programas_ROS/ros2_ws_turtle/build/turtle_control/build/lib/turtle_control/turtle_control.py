...
###########################################################################################
    ...
    def callback_controle(self, posicao: Pose):
        ...
        if self.estado == "ROTACIONAR_X": #Controle de posição angular para orientação a x
            ...
            self.theta_error_x = self.normalize_angle(self.theta_error_x) # NORMALIZAR O ERRO para [-π, π]
            ...
            self.theta_error_y = self.normalize_angle(self.theta_error_y) # NORMALIZAR O ERRO para [-π, π]
